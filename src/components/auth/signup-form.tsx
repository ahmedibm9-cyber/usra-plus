        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-2">
              ...
              <div className="relative">
                <User className={`absolute top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500 ${isRTL ? 'right-3' : 'left-3'}`} />
                <Input
                  id="signup-firstName"
                  type="text"
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              ...
              <div className="relative flex-1">
                <Phone className={`absolute top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500 ${isRTL ? 'right-3' : 'left-3'}`} />
                <Input
                  id="signup-phone"
                  type="tel"
