      ...
      <div className="w-full max-w-md mx-auto bg-[--bg-surface] rounded-3xl p-8 relative z-10 border border-[--border-subtle] shadow-2xl" dir={isRTL ? 'rtl' : 'ltr'}>
        ...
        {adminError && showAdminLogin && (
          <motion.div
            initial={{ opacity: 0, height: 0 }}
            animate={{ opacity: 1, height: 'auto' }}
            className="mt-4 flex items-start gap-3 p-3 rounded-lg bg-[#FF3B30]/10 border border-[#FF3B30]/20"
          >
            <AlertTriangle className="w-4 h-4 text-[#FF3B30] mt-0.5 shrink-0" />
            <div>
              <p className="text-sm text-[#FF3B30]">{adminError}</p>
        ...
        <form onSubmit={showAdminLogin ? handleAdminSubmit : handleSubmit} className="space-y-4 mt-6">
          ...
          >
            ...
            <div className="auth-input-wrapper">
              ...
              <Input
                ...
                className={`h-11 premium-input bg-[--bg-surface-2] border-[--border-subtle] text-[--text-primary] placeholder:text-[--text-muted] rounded-xl focus:border-[#007AFF] focus:ring-[#007AFF]/20 ${showAdminLogin ? 'focus:border-[#F4C430] focus:ring-[#F4C430]/20' : ''} ${isRTL ? 'pr-10 pl-3' : 'pl-10 pr-3'} ${errors.email ? 'border-[#FF3B30]/50' : ''}`}
                disabled={isLoading}
                autoComplete="off"
              />
            </div>
          ...
          >
            ...
            <div className="auth-input-wrapper">
              ...
              <Input
                ...
                className={`h-11 premium-input bg-[--bg-surface-2] border-[--border-subtle] text-[--text-primary] placeholder:text-[--text-muted] rounded-xl focus:border-[#007AFF] focus:ring-[#007AFF]/20 ${showAdminLogin ? 'focus:border-[#F4C430] focus:ring-[#F4C430]/20' : ''} ${isRTL ? 'pr-10 pl-10' : 'pl-10 pr-10'} ${errors.password ? 'border-[#FF3B30]/50' : ''}`}
                disabled={isLoading}
                autoComplete="off"
              />
              <button
          ...
          {/* Submit Button — morphs between user and admin */}
          <motion.div
            initial={{ opacity: 0, y: 8 }}
            animate={{ opacity: 1, y: 0 }}
