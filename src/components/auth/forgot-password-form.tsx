...
export function ForgotPasswordForm() {
  ...
  if (isSent) {
    return (
      <div className="w-full max-w-md mx-auto text-center space-y-6" dir={isRTL ? 'rtl' : 'ltr'}>
        ...
        <Button
          ...
          variant="outline"
          className="w-full border-white/[0.08] bg-[#111117] text-gray-300 hover:bg-[#1a1a22] hover:text-gray-200 rounded-2xl h-11"
        >
    ...
    <div className="w-full max-w-md mx-auto space-y-6" dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <Button
          type="submit"
          disabled={isLoading}
          className="w-full bg-indigo-500 hover:bg-indigo-600 text-white rounded-2xl h-11 font-medium transition-all duration-200 disabled:opacity-50"
        >
          {isLoading ? (
