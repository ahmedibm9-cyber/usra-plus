...
// ─── Color Options ───────────────────────────────────────────────
const COLOR_OPTIONS = [
  { name: 'teal', bg: 'bg-[var(--accent-primary)]', light: 'bg-[var(--accent-primary)]/20', border: 'border-[var(--accent-primary)]', text: 'text-[var(--accent-primary)]', hex: 'var(--accent-primary)' },
  { name: 'emerald', bg: 'bg-[var(--accent)]', light: 'bg-[var(--accent)]/20', border: 'border-[var(--accent)]', text: 'text-[var(--accent)]', hex: 'var(--accent)' },
  { name: 'green', bg: 'bg-[#22C55E]', light: 'bg-[#22C55E]/20', border: 'border-[#22C55E]', text: 'text-[#22C55E]', hex: '#22C55E' },
  { name: 'jade', bg: 'bg-[var(--accent)]', light: 'bg-[var(--accent)]/20', border: 'border-[var(--accent)]', text: 'text-[var(--accent)]', hex: 'var(--accent)' },
  { name: 'mint', bg: 'bg-[var(--secondary)]', light: 'bg-[var(--secondary)]/20', border: 'border-[var(--secondary)]', text: 'text-[var(--secondary)]', hex: 'var(--secondary)' },
...
const FAMILY_BENEFITS = [
  { icon: Shield, text: 'Private & secure space', color: 'var(--accent-primary)' },
  { icon: Users, text: 'Up to 20 family members', color: 'var(--accent)' },
  { icon: Zap, text: 'Real-time sync & updates', color: 'var(--accent-primary)' },
]
      ...
      {particles.map((p) => (
        <motion.div
          ...
          style={{
            ...
            width: p.size,
            height: p.size,
            backgroundColor: p.id % 3 === 0 ? 'var(--accent-primary)' : 'var(--accent)',
          }}
          animate={{
            y: [0, -30, 0],
    ...
    <div className="w-full mb-8">
      ...
      <div className="relative h-1 bg-[--border-subtle] rounded-full overflow-hidden">
        <motion.div
          ...
          style={{
            background: 'linear-gradient(90deg, var(--accent-primary), var(--accent))',
          }}
          initial={{ width: '0%' }}
        ...
        <motion.div
          ...
          style={{
            ...
            boxShadow: '0 0 8px color-mix(in srgb, var(--accent) 60%, transparent), 0 0 16px color-mix(in srgb, var(--accent-primary) 30%, transparent)',
          }}
      ...
      <div className="flex justify-end mt-1.5">
        <span className="font-metric text-[10px] text-[var(--accent)] tracking-wider">
          {percentage}%
        </span>
      </div>
    </div>
        ...
        <motion.div
          animate={{
            boxShadow: [
              ...
              '0 0 60px 10px color-mix(in srgb, var(--accent-primary) 20%, transparent)',
              '0 0 0 0 color-mix(in srgb, var(--accent-primary) 0%, transparent)',
            ],
          }}
          transition={{ duration: 3, repeat: Infinity, ease: 'easeInOut' }}
          className="w-28 h-28 rounded-[2rem] bg-gradient-to-br from-[var(--accent-primary)] via-[var(--primary)] to-[var(--secondary)] flex items-center justify-center relative"
        >
      ...
      <div className="h-8 mb-8">
        ...
        >
          ...
          <motion.span
            ...
            className="inline-block w-[2px] h-5 bg-[var(--accent-primary)] ml-0.5 align-middle"
          />
        </p>
      </div>
        ...
        {showButton && (
          ...
          >
            <Button
              ...
              className="w-full h-13 bg-[var(--accent-primary)] hover:bg-[var(--primary)] text-white text-base font-semibold rounded-xl btn-press transition-all duration-300 hover:shadow-[0_0_40px_color-mix(in_srgb,var(--accent-primary)_40%,transparent)] relative overflow-hidden group"
              style={{ fontFamily: "'Space Grotesk', sans-serif" }}
            >
              {/* Shimmer effect */}
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <motion.button
                ...
                className="group relative rounded-2xl p-6 bg-[--bg-surface] border border-[--border-subtle] hover:border-[var(--accent-primary)]/40 transition-all duration-300 text-left overflow-hidden"
                style={{
                  boxShadow: '0 0 0 0 color-mix(in srgb, var(--accent-primary) 0%, transparent)',
                }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.boxShadow = '0 8px 30px color-mix(in srgb, var(--accent-primary) 12%, transparent)'
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.boxShadow = '0 0 0 0 color-mix(in srgb, var(--accent-primary) 0%, transparent)'
                }}
              >
                {/* Animated gradient bg on hover */}
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-[var(--accent-primary)]/8 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                {/* Top accent line */}
                <div className="absolute top-0 left-4 right-4 h-[2px] bg-gradient-to-r from-transparent via-[var(--accent-primary)]/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                <div className="relative z-10">
                  <div className="w-14 h-14 rounded-2xl bg-[var(--accent-primary)]/15 flex items-center justify-center mb-4 group-hover:bg-[var(--accent-primary)]/25 transition-colors duration-300">
                  ...
                  <div className="mt-3 flex items-center gap-1 text-[var(--accent-primary)] text-xs font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <span>Create</span>
              ...
              <motion.button
                ...
                className="group relative rounded-2xl p-6 bg-[--bg-surface] border border-[--border-subtle] hover:border-[var(--accent)]/40 transition-all duration-300 text-left overflow-hidden"
                style={{
                  boxShadow: '0 0 0 0 color-mix(in srgb, var(--accent) 0%, transparent)',
                }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.boxShadow = '0 8px 30px color-mix(in srgb, var(--accent) 10%, transparent)'
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.boxShadow = '0 0 0 0 color-mix(in srgb, var(--accent) 0%, transparent)'
                }}
              >
                {/* Animated gradient bg on hover */}
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-[var(--accent)]/8 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                {/* Top accent line */}
                <div className="absolute top-0 left-4 right-4 h-[2px] bg-gradient-to-r from-transparent via-[var(--accent)]/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                <div className="relative z-10">
                  <div className="w-14 h-14 rounded-2xl bg-[var(--accent)]/15 flex items-center justify-center mb-4 group-hover:bg-[var(--accent)]/25 transition-colors duration-300">
                  ...
                  <div className="mt-3 flex items-center gap-1 text-[var(--accent)] text-xs font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <span>Join</span>
                    <ChevronRight className="w-3 h-3" />
                  </div>
                </div>
              ...
              <div className="p-6 space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="bg-[--bg-primary] border-[--border-subtle] text-[--text-primary] placeholder:text-[--text-muted] h-11 focus:border-[var(--accent-primary)]/50 focus:ring-[var(--accent-primary)]/20 transition-colors"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    className="bg-[--bg-primary] border-[--border-subtle] text-[--text-primary] placeholder:text-[--text-muted] resize-none focus:border-[var(--accent-primary)]/50 focus:ring-[var(--accent-primary)]/20 transition-colors"
                    rows={3}
                  />
                </div>
                ...
                <div className="flex gap-3 pt-1">
                  ...
                  <Button
                    ...
                    className="flex-1 bg-[var(--accent-primary)] hover:bg-[var(--primary)] text-white h-11 font-semibold hover:shadow-[0_0_20px_color-mix(in_srgb,var(--accent-primary)_30%,transparent)] transition-all duration-300"
                    style={{ fontFamily: "'Space Grotesk', sans-serif" }}
                  >
              ...
              <div className="p-6 space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="bg-[--bg-primary] border-[--border-subtle] text-[--text-primary] font-metric text-lg tracking-[0.3em] text-center placeholder:text-[--text-muted] placeholder:tracking-widest h-12 focus:border-[var(--accent)]/50 focus:ring-[var(--accent)]/20 transition-colors"
                    maxLength={8}
                  />
                </div>
                ...
                <div className="flex gap-3 pt-1">
                  ...
                  <Button
                    ...
                    className="flex-1 bg-[var(--accent)] hover:bg-[var(--accent)] text-white font-semibold h-11 hover:shadow-[0_0_20px_color-mix(in_srgb,var(--accent)_30%,transparent)] transition-all duration-300"
                    style={{ fontFamily: "'Space Grotesk', sans-serif" }}
                  >
  ...
  return (
    <div className="w-full max-w-lg mx-auto space-y-7">
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          ...
          <Button
            ...
            className="border-[var(--accent-primary)]/30 text-[var(--accent-primary)] hover:bg-[var(--accent-primary)]/10 hover:text-[var(--primary)] h-7 text-xs"
          >
            ...
            <motion.button
              ...
              className={`w-full aspect-square rounded-xl flex items-center justify-center text-2xl transition-all duration-200 relative overflow-hidden ${
                familyAvatar === emoji && !aiAvatarUrl
                  ...
                  : 'bg-[--bg-surface] border border-[--border-subtle] hover:border-[var(--accent-primary)]/30'
              }`}
            >
              {emoji}
              {/* Hover glow ring */}
              {familyAvatar !== emoji && (
                <div className="absolute inset-0 rounded-xl bg-[var(--accent-primary)]/5 opacity-0 hover:opacity-100 transition-opacity duration-200" />
              )}
              {/* Selected indicator dot */}
              {familyAvatar === emoji && !aiAvatarUrl && (
                <motion.div
                  layoutId="avatar-selected"
                  className="absolute -bottom-0.5 w-1.5 h-1.5 rounded-full bg-[var(--accent-primary)]"
                  style={{ boxShadow: '0 0 6px color-mix(in srgb, var(--accent-primary) 60%, transparent)' }}
                />
              )}
            </motion.button>
          ))}
      ...
      >
        <Button
          onClick={onComplete}
          className="w-full h-13 bg-[var(--accent-primary)] hover:bg-[var(--primary)] text-white font-semibold rounded-xl btn-press transition-all duration-300 hover:shadow-[0_0_40px_color-mix(in_srgb,var(--accent-primary)_40%,transparent)] flex items-center justify-center gap-2 relative overflow-hidden group"
          style={{ fontFamily: "'Space Grotesk', sans-serif" }}
        >
          {/* Shimmer effect */}
          <div className="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-1000 bg-gradient-to-r from-transparent via-white/10 to-transparent" />
  ...
  return (
    <div className="min-h-screen bg-[--bg-primary] auth-bg flex items-center justify-center p-4">
      ...
      <motion.div
        ...
        style={{
          boxShadow: '0 0 80px color-mix(in srgb, var(--accent-primary) 4%, transparent), 0 0 160px color-mix(in srgb, var(--accent) 2%, transparent)',
        }}
      >
        {/* Progress Bar */}
          ...
          <div className="flex items-center gap-2">
            <div
              ...
              style={{
                ...
                boxShadow: '0 0 6px color-mix(in srgb, var(--accent-primary) 50%, transparent)',
              }}
            />
            <span className="font-metric text-[10px] tracking-[0.3em] uppercase text-[var(--accent-primary)]">
              {currentStep}/3
            </span>
          </div>
          <h2
