    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            onClick={addSection}
            className="bg-[var(--accent-primary)]/10 text-[var(--accent-primary)] border border-[var(--accent-primary)]/20 hover:bg-[var(--accent-primary)]/20 h-8 text-xs"
          >
      ...
      <div>
        ...
        <Input
          ...
          className="bg-[--bg-primary] border-[--border-subtle] text-[--text-primary] text-sm focus:border-[var(--accent-primary)]/30"
        />
      </div>
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full bg-[--bg-primary] border border-[--border-subtle] rounded-lg px-3 py-2 text-sm text-[--text-primary] placeholder-[--text-muted] focus:outline-none focus:border-[var(--accent-primary)]/30 resize-y"
  ...
  return (
    <div className="space-y-2">
      <h4 className="text-xs text-[--text-muted] uppercase tracking-wider flex items-center gap-1.5">
        <Copy className="w-3 h-3 text-[var(--accent-primary)]" /> Available Variables
      </h4>
      <div className="grid grid-cols-1 gap-1.5">
        {vars.map(v => (
          <button
            ...
            className="flex items-center justify-between p-2 bg-[--bg-primary] rounded-lg border border-[--border-subtle] hover:border-[var(--accent-primary)]/30 transition-colors text-left group"
          >
            <div>
              <code className="text-xs text-[var(--accent-primary)] font-metric">{v.key}</code>
...
function SocialMediaPreview({ branding }: { branding: AppBranding }) {
  return (
    <div className="space-y-3">
      <h4 className="text-xs text-[--text-muted] uppercase tracking-wider flex items-center gap-1.5">
        <Share2 className="w-3 h-3 text-[var(--accent-primary)]" /> Social Media Preview
      </h4>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <Button
              onClick={handleSave}
              disabled={isSaving}
              className="bg-[var(--accent-primary)]/10 text-[var(--accent-primary)] border border-[var(--accent-primary)]/20 hover:bg-[var(--accent-primary)]/20 h-9"
            >
          ...
          <TabsList className="bg-[--bg-surface] border border-[--border-subtle] p-1 h-auto flex-wrap gap-1 w-full">
            {tabItems.map(tab => (
              <TabsTrigger
                key={tab.value}
                value={tab.value}
                className="text-[--text-muted] hover:text-[--text-secondary] px-3 py-1.5 text-xs sm:text-sm gap-1.5 rounded-lg relative data-[state=active]:bg-[var(--accent-primary)]/10 data-[state=active]:text-[var(--accent-primary)] data-[state=active]:shadow-none transition-all"
              >
                {tab.icon}
                ...
                {activeTab === tab.value && (
                  <motion.div
                    ...
                    style={{ background: 'linear-gradient(90deg, var(--accent-primary), var(--accent))' }}
                  />
                )}
              </TabsTrigger>
            ))}
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex items-center justify-between mb-6">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Button
                          ...
                          className="bg-[var(--accent-primary)]/10 text-[var(--accent-primary)] border border-[var(--accent-primary)]/20 hover:bg-[var(--accent-primary)]/20 h-8 text-[10px] px-2"
                        >
                          <Download className="w-3 h-3 mr-1" /> Export
                        </Button>
                        <Button
                          onClick={() => importInputRef.current?.click()}
                          className="bg-[var(--accent)]/10 text-[var(--accent)] border border-[var(--accent)]/20 hover:bg-[var(--accent)]/20 h-8 text-[10px] px-2"
                        >
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <Input
                              value={branding.primaryColor}
                              onChange={e => { setBranding({ ...branding, primaryColor: e.target.value }); markChanged() }}
                              className="bg-[--bg-primary] border-[--border-subtle] text-[--text-primary] text-sm focus:border-[var(--accent-primary)]/30 flex-1"
                            />
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                        ...
                        <div>
                          ...
                          <select
                            ...
                            className="w-full bg-[--bg-primary] border border-[--border-subtle] rounded-lg px-3 py-2 text-sm text-[--text-primary] focus:outline-none focus:border-[var(--accent-primary)]/30"
                          >
                        ...
                        <div>
                          ...
                          <div className="space-y-2">
                            <input
                              ...
                              className="w-full accent-[var(--accent-primary)] h-2"
                            />
                            <div className="flex justify-between">
                              {BORDER_RADIUS_OPTIONS.map((opt, i) => (
                                <button
                                  ...
                                  className={`text-[9px] transition-colors ${branding.borderRadius === opt.value ? 'text-[var(--accent-primary)] font-bold' : 'text-[--text-muted] hover:text-[--text-secondary]'}`}
                                >
                                  {opt.label}
                                </button>
                              ))}
                  ...
                  <ContentCard className="p-6">
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <Badge className="text-[9px] bg-[var(--accent)]/10 text-[var(--accent)] border-[var(--accent)]/20 ml-2">Real-time</Badge>
                    </div>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="pt-4 border-t border-[--border-subtle]">
                        <h4 className="text-xs text-[--text-muted] uppercase tracking-wider mb-4 flex items-center gap-1.5">
                          <Bell className="w-3 h-3 text-[var(--accent)]" /> Notification Settings
                        </h4>
                        <div className="space-y-3">
                          <ConfigToggle
                      ...
                      <div className="pt-4 border-t border-[--border-subtle]">
                        <h4 className="text-xs text-[--text-muted] uppercase tracking-wider mb-4 flex items-center gap-1.5">
                          <Shield className="w-3 h-3 text-[var(--accent-primary)]" /> Security & Rate Limiting
                        </h4>
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                          <div>
                            ...
                            <Input
                              ...
                              className="bg-[--bg-primary] border-[--border-subtle] text-[--text-primary] text-sm focus:border-[var(--accent-primary)]/30 font-metric"
                              min={10}
                              max={1000}
                            />
                          </div>
                      ...
                      <div className="pt-4 border-t border-[--border-subtle]">
                        <h4 className="text-xs text-[--text-muted] uppercase tracking-wider mb-4 flex items-center gap-1.5">
                          <MessageSquare className="w-3 h-3 text-[var(--accent)]" /> Content Moderation
                        </h4>
                        <div className="space-y-3">
                          <ConfigToggle
                      ...
                      <div className="pt-4 border-t border-[--border-subtle]">
                        <h4 className="text-xs text-[--text-muted] uppercase tracking-wider mb-4 flex items-center gap-1.5">
                          <FileDown className="w-3 h-3 text-[var(--accent-primary)]" /> Data & Privacy
                        </h4>
                        <div className="space-y-3">
                          <ConfigToggle
                            label={
                              <>
                                GDPR Data Export
                                <Badge className="text-[9px] bg-[var(--accent)]/10 text-[var(--accent)] border-[var(--accent)]/20 ml-1">COMPLIANCE</Badge>
                              </>
                            }
                ...
                <ContentCard className="p-6">
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <h4 className="text-xs text-[--text-muted] uppercase tracking-wider flex items-center gap-2">
                          <Check className="w-3 h-3 text-[var(--accent)]" /> Welcome Email
                        </h4>
                        <Button
                          onClick={() => handleSendTestEmail('welcome')}
                          className="bg-[var(--accent-primary)]/10 text-[var(--accent-primary)] border border-[var(--accent-primary)]/20 hover:bg-[var(--accent-primary)]/20 h-7 text-[10px] px-2"
                        >
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          rows={5}
                          className="w-full bg-[--bg-primary] border border-[--border-subtle] rounded-lg px-3 py-2 text-sm text-[--text-primary] placeholder-[--text-muted] focus:outline-none focus:border-[var(--accent-primary)]/30 resize-y font-mono"
                        />
                      </div>
                      <EmailPreview
                    ...
                    <div className="space-y-3 pt-4 border-t border-[--border-subtle]">
                      <div className="flex items-center justify-between">
                        <h4 className="text-xs text-[--text-muted] uppercase tracking-wider flex items-center gap-2">
                          <Mail className="w-3 h-3 text-[var(--accent-primary)]" /> Family Invitation Email
                        </h4>
                        <Button
