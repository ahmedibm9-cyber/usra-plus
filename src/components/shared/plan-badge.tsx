 ...
 return (
  <div className="flex items-center gap-2 p-3 rounded-xl bg-gradient-to-r from-primary/10 to-accent/10 border border-accent/20">
   ...
   <p className="text-xs text-[#F5F5F0]/70 font-['Inter',sans-serif]">
    {currentCount}/{limit} {feature} on Free plan. <span className="text-accent font-medium cursor-pointer hover:text-[var(--secondary)] font-['Space_Grotesk',sans-serif]">Upgrade to Pro</span> for unlimited.
   </p>
  </div>
 )
}
