...
function TooltipArrow({ placement, top, left }: { placement: TooltipPlacement; top: number; left: number }) {
  ...
  return (
    <div className="absolute z-50" style={{ top, left }}>
      <div
        className={`${rotations[placement]} border-[var(--border-subtle)]`}
        style={{
          width: 0,
          height: 0,
  ...
  return (
    <div className="grid grid-cols-4 gap-3 my-6">
      {previewSteps.map((step, i) => (
        ...
        >
          <div className="flex size-9 items-center justify-center rounded-xl bg-[var(--accent-primary)]/15">
            <step.icon className="size-4 text-[var(--accent-primary)]" />
          </div>
      ...
      <div className="fixed inset-0 z-[100]" role="dialog" aria-label="Guided tour" dir={isRTL ? 'rtl' : 'ltr'}>
        ...
        {spotlightRect && !showWelcome && !showCelebration && (
          <motion.div
            ...
            transition={spotlightSpring}
            className="absolute rounded-xl border-2 border-[var(--accent-primary)]/60 pointer-events-none"
            style={{
              boxShadow: '0 0 20px 6px color-mix(in srgb, var(--accent-primary) 15%, transparent)',
            }}
          >
            {/* Pulsing ring animation around spotlight */}
            <motion.div
              className="absolute -inset-2 rounded-xl border-2 border-[var(--accent-primary)]/30"
              animate={{
                opacity: [0.3, 0.7, 0.3],
                scale: [1, 1.02, 1],
              }}
        ...
        {showWelcome && (
          ...
          >
            <div className="rounded-2xl border border-[var(--border-subtle)] bg-[var(--bg-surface)] backdrop-blur-xl shadow-2xl shadow-black/40 overflow-hidden relative">
              {/* Ambient glow blobs */}
              <div className="absolute -top-20 -left-20 w-40 h-40 rounded-full blur-3xl pointer-events-none" style={{ background: 'color-mix(in srgb, var(--accent-primary) 10%, transparent)' }} />
              <div className="absolute -bottom-20 -right-20 w-40 h-40 rounded-full blur-3xl pointer-events-none" style={{ background: 'color-mix(in srgb, var(--accent-secondary) 10%, transparent)' }} />
          ...
          >
            ...
            <div className="rounded-2xl border border-[var(--border-subtle)] bg-[var(--bg-surface)] backdrop-blur-xl shadow-2xl shadow-black/40 overflow-hidden relative">
              ...
              <div
                ...
                style={{ background: 'color-mix(in srgb, var(--accent-primary) 8%, transparent)' }}
              />
              ...
              <div className="relative p-5" aria-live="assertive">
                ...
                <div className="flex items-center justify-between mb-3">
                    ...
                    <motion.div
                      ...
                      animate={{
                        boxShadow: [
                          ...
                          '0 0 8px 2px color-mix(in srgb, var(--accent-primary) 15%, transparent)',
                          '0 0 0 0 color-mix(in srgb, var(--accent-primary) 0%, transparent)',
                        ],
                      }}
                      transition={{ duration: 2.5, repeat: Infinity, ease: 'easeInOut' }}
                    >
                      <step.icon className="size-4" style={{ color: 'var(--accent-primary)' }} />
                    </motion.div>
                  ...
                  <button
                    onClick={skipTour}
                    className="flex size-6 items-center justify-center rounded-md text-[var(--text-muted)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-surface-2)] transition-colors"
                  ...
                  <div className="flex items-center gap-1">
                    {!isFirstStep ? (
                      <Button
                        ...
                        size="sm"
                        onClick={prevStep}
                        className="text-[var(--text-muted)] hover:text-[var(--text-primary)] h-8 px-2.5 text-xs"
                      >
                ...
                {/* Slim progress bar */}
                <div className="mt-4 h-1 w-full rounded-full bg-[var(--bg-surface-2)] overflow-hidden">
                  <motion.div
                ...
                {/* Keyboard hints */}
                <p className="mt-2 text-[10px] text-[var(--text-muted)]/60 text-center select-none">
                  {tourT.keyboardHints}
                </p>
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-[var(--border-subtle)] bg-[var(--bg-surface)] backdrop-blur-xl shadow-2xl shadow-black/40 overflow-hidden relative">
              ...
              <div className="relative p-10 text-center">
                ...
                <motion.div
                  ...
                  style={{
                    background: 'linear-gradient(135deg, color-mix(in srgb, var(--accent-primary) 15%, transparent), color-mix(in srgb, var(--accent-secondary) 15%, transparent))',
                  }}
                >
                  <motion.div
                  ...
                  >
                    <CheckCircle2 className="size-10" style={{ color: 'var(--accent-primary)' }} />
                  </motion.div>
                </motion.div>
