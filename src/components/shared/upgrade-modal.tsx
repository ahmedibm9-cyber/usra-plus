        ...
        <AnimatePresence>
          {open && (
            <div className="relative">
              {/* Ambient glow */}
              <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[400px] h-[200px] bg-gradient-to-b from-[--accent-primary]/10 via-[#E50914]/5 to-transparent rounded-full blur-3xl pointer-events-none" />
              ...
              >
                <div className="mx-auto mb-3 flex size-12 items-center justify-center rounded-2xl bg-gradient-to-br from-[--accent-primary] to-[#C40812] shadow-lg shadow-[--accent-primary]/20">
                  ...
                  <Badge
                    ...
                    className={`text-[10px] px-2 py-0 h-5 font-semibold ${
                      plan === 'free'
                        ...
                        : plan === 'pro'
                          ? 'bg-[#F4C430]/20 text-[#F4C430] border-[#F4C430]/30'
              ...
              >
                <div className="grid grid-cols-3 gap-2.5">
                  ...
                  <div className="relative bg-[--bg-primary] rounded-xl p-3.5 flex flex-col overflow-hidden">
                    {/* Gradient border */}
                    <div className="absolute inset-0 rounded-xl p-[1px] bg-gradient-to-b from-[--accent-primary]/60 via-[#E50914]/30 to-[--accent-primary]/10 pointer-events-none">
                      <div className="w-full h-full rounded-xl bg-[--bg-primary]" />
                    </div>

                    {/* Popular badge */}
                    <div className="absolute -top-0 right-2">
                      <Badge className="bg-[--accent-primary] text-white border-0 text-[9px] px-2 py-0 h-4">
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="space-y-1.5">
                        {PLAN_FEATURES.map((feat) => {
                          ...
                          return (
                            <div key={feat.key} className="flex items-center gap-1.5">
                              <Check className="size-3 text-[--accent-primary] shrink-0" />
                      ...
                      <Button
                        ...
                        className="w-full mt-3 h-8 text-xs bg-[--accent-primary] hover:bg-[--accent-primary]/90 text-white shadow-lg shadow-[--accent-primary]/20 btn-glow btn-press btn-cta-glow"
                        disabled={plan === 'pro'}
                      >
                        {plan === 'pro'
                          ? (isRTL ? 'الخطة الحالية' : 'Current Plan')
              ...
              >
                <div className="grid grid-cols-3 gap-2">
                  <div className="flex items-center gap-2 p-2 rounded-lg bg-[--border-subtle] border border-[--border-subtle]">
                    <Infinity className="size-4 text-[--accent-primary] shrink-0" />
                    <span className="text-[10px] text-[--text-secondary]">
                      {isRTL ? 'مهام غير محدودة' : 'Unlimited Tasks'}
                    </span>
                  </div>
                  <div className="flex items-center gap-2 p-2 rounded-lg bg-[--border-subtle] border border-[--border-subtle]">
                    <Zap className="size-4 text-[#E50914] shrink-0" />
                    <span className="text-[10px] text-[--text-secondary]">
