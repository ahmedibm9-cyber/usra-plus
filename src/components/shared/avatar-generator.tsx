  ...
  return (
    <div className="rounded-xl aspect-square bg-[--border-subtle] animate-pulse overflow-hidden relative">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <Loader2 className="size-6 text-[--text-primary]/20 animate-spin" />
      </div>
    </div>
  )
}
  ...
  return (
    <motion.button
      ...
      className={`rounded-xl overflow-hidden aspect-square bg-[--border-subtle] cursor-pointer transition-all relative ${
        isSelected
          ? 'ring-2 ring-[--accent-primary] shadow-[0_0_16px_rgba(229, 9, 20,0.3)]'
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-[--bg-surface] border-[--border-subtle] text-[--text-primary] max-w-lg sm:max-w-md p-0 overflow-hidden">
        ...
        <DialogHeader className="p-5 pb-0">
          <DialogTitle className="text-[--text-primary] text-lg font-semibold flex items-center gap-2">
        ...
        <div className="p-5 space-y-5 max-h-[70vh] overflow-y-auto custom-scrollbar">
          ...
          <div>
            ...
            <Input
              ...
              className="bg-[--border-subtle] border-[--border-subtle] text-[--text-primary] placeholder:text-[--text-muted] focus-visible:ring-[--accent-primary]/30"
            />
          </div>
            ...
            >
              ...
              <div className="flex gap-3 mt-4">
                <Button
                  variant="outline"
                  onClick={handleGenerate}
                  className="flex-1 border-[--border-subtle] text-[--text-secondary] hover:bg-[--border-subtle] hover:text-[--text-primary] rounded-xl h-10"
                >
