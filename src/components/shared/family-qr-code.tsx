...
export function FamilyQRCode({ inviteCode, familyName, size = 200 }: FamilyQRCodeProps) {
  ...
  return (
    ...
    >
      {/* Family Name */}
      <h4 className="text-[--text-primary] text-base font-semibold mb-3 text-center">
        {familyName}
      </h4>

      {/* QR Code with white background for scannability */}
      <div className="bg-white rounded-xl p-4 mx-auto shadow-[0_0_24px_-4px_rgba(99,102,241,0.1)]">
