        ...
        >
          ...
          <div className="relative z-10">
            ...
            >
              <button
                onClick={onRetry}
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-[#E50914] hover:bg-[#E50914] text-white text-sm font-medium transition-colors duration-200 active:scale-[0.98]"
              >
