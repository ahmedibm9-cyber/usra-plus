...
function MemberLeaderboard({
  ...
  const rankStyles: Record<number, { color: string; bgColor: string; icon: React.ElementType }> = {
    1: { color: 'text-amber-400', bgColor: 'bg-amber-500/15', icon: Trophy },
    2: { color: 'text-gray-300', bgColor: 'bg-gray-500/15', icon: Medal },
          ...
          return (
            ...
            >
              ...
              <Avatar className="h-6 w-6">
                ...
                <AvatarFallback className="bg-[#6366F1]/20 text-[8px] text-[#A78BFA]">
    ...
    >
      ...
      <div className="min-w-0">
        <div className="flex items-center gap-1.5">
          <span className="text-lg font-bold text-[--text-primary]">{streakDays}</span>
...
export function FamilyAnalyticsWidget() {
  ...
  const productivityScore = useMemo(() => {
    ...
    const groceryItems = groceryStore.items
  ...
  }, [taskStore.tasks, groceryStore.items])
  ...
  return (
    ...
    >
      <div className="glass-card glass rounded-2xl border border-[--border-subtle] bg-[--bg-surface] shadow-[inset_0_1px_0_var(--border-subtle)] hover:-translate-y-0.5 hover:shadow-lg hover:shadow-black/20 transition-all duration-200 p-6">
        {/* Header */}
        <div className="mb-5 flex items-center gap-2">
          <div className="flex size-7 items-center justify-center rounded-lg bg-[--accent-primary]/15">
        ...
        <div className="grid gap-6 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1 flex flex-col gap-3">
            ...
            <motion.div
              ...
              className="flex items-center gap-3 rounded-xl border border-[--border-subtle] bg-[--bg-surface-2] p-3"
            >
              <div className="flex size-10 items-center justify-center rounded-xl bg-emerald-500/15 shrink-0">
