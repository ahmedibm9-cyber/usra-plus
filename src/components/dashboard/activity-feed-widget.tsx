  ...
  return (
    ...
    >
      ...
      <div className="relative mt-0.5 shrink-0">
        ...
        {isOnline && (
          <span className="absolute -bottom-0.5 -right-0.5 size-2.5 rounded-full bg-green-400 ring-2 ring-[var(--bg-surface)] online-dot-pulse" />
        )}
      </div>
    ...
    <GlassCard delay={0.5} className="p-5">
      ...
      <div className="mb-4 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <Activity className="size-4 text-[#6366F1]" />
