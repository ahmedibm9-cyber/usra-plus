...
function ActivityFeedItem({
 ...
 return (
  <motion.div
   ...
   className={`relative flex items-start gap-3 rounded-lg p-2.5 transition-colors hover:bg-border ${!isLast ? 'pb-4' : ''}`}
  >
   {/* Timeline line */}
   {!isLast && (
   ...
   <div className="relative mt-0.5 shrink-0">
    <Avatar className="h-8 w-8 rounded-full ring-2 ring-[var(--card)]">
    ...
    {isOnline && (
     <span className="absolute -bottom-0.5 -right-0.5 size-2.5 rounded-full bg-green-400 ring-2 ring-[var(--card)] led-indicator led-indicator-active online-dot-pulse" />
    )}
   </div>
