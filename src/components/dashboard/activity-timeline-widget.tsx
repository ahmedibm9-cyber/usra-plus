...
export function ActivityTimelineWidget() {
  ...
  return (
    ...
    >
      <div className="glass-card glass rounded-2xl border border-[--border-subtle] bg-[--bg-surface] shadow-[inset_0_1px_0_var(--border-subtle)] hover:-translate-y-0.5 hover:shadow-lg hover:shadow-black/20 transition-all duration-200 p-5">
        {/* Header */}
        ...
        {allFlat.length > DEFAULT_VISIBLE && (
          <div className="mt-3 flex justify-center">
            <Button
              ...
              className="h-7 text-xs text-[--text-muted] hover:text-[--accent-primary] gap-1"
            >
              {showAll ? (
                <>
                  {t.activity.showLess}
