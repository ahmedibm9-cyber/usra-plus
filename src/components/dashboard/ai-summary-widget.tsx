      ...
      <div className="relative overflow-hidden rounded-2xl border border-white/[0.08] bg-[#111117] p-5">
        ...
        <div className="relative z-10">
          ...
          <div className="mb-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <span className="bg-gradient-to-r from-[#6366F1] to-[#A78BFA] text-white text-[10px] font-bold px-2 py-0.5 rounded-full">
            ...
            {isGenerating ? (
              <div className="flex items-center gap-2">
                <div className="flex gap-1">
                  <span className="size-1.5 rounded-full bg-[#6366F1] animate-bounce" style={{ animationDelay: '0ms' }} />
          ...
          <div className="pointer-events-none mt-3 h-[1px] w-full bg-gradient-to-r from-transparent via-[#6366F1]/20 to-transparent" />
        </div>
      </div>
    </motion.div>
  )
