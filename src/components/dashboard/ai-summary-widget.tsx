...
export function AISummaryWidget({
  ...
  return (
    <motion.div
      ...
      transition={{ duration: 0.4, ease: [0.25, 0.46, 0.45, 0.94] }}
    >
      <div className="relative overflow-hidden rounded-2xl border border-[--border-subtle] bg-[--bg-surface] dot-grid-bg p-5">
        {/* Gradient border overlay */}
        <div className="pointer-events-none absolute inset-0 rounded-2xl border border-transparent bg-gradient-to-r from-[#E50914]/20 to-[#F4C430]/20 bg-clip-padding p-[1px]">
        ...
        <div className="relative z-10">
          ...
          <div className="mb-4 flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <div className="relative flex size-8 items-center justify-center rounded-lg bg-gradient-to-br from-[#E50914]/20 to-[#F4C430]/20">
                <Sparkles className="size-4 text-[#F4C430] animate-pulse" />
              </div>
            ...
            <div className="flex items-center gap-2">
              <span className="bg-gradient-to-r from-[#E50914] to-[#F4C430] text-white text-[10px] font-bold px-2 py-0.5 rounded-full">
            ...
            {isGenerating ? (
              <div className="flex items-center gap-2">
                <div className="flex gap-1">
                  <span className="size-1.5 rounded-full bg-[#E50914] animate-bounce" style={{ animationDelay: '0ms' }} />
                  <span className="size-1.5 rounded-full bg-[#E50914] animate-bounce" style={{ animationDelay: '150ms' }} />
                  <span className="size-1.5 rounded-full bg-[#E50914] animate-bounce" style={{ animationDelay: '300ms' }} />
                </div>
              ...
              <p className="text-sm leading-relaxed text-[--text-secondary]">
                {displayedText}
                {isTyping && (
                  <span className="animate-pulse border-r-2 border-[#E50914] ml-0.5">&nbsp;</span>
                )}
              </p>
            )}
          </div>
          ...
          <div className="pointer-events-none mt-3 h-[1px] w-full bg-gradient-to-r from-transparent via-[#E50914]/20 to-transparent" />
        </div>
      </div>
    </motion.div>
  )
