...
const PRIORITY_CONFIG: Record<TaskPriority, { color: string; bg: string; dot: string; label: string }> = {
  ...
  high: { color: 'text-orange-400', bg: 'bg-orange-500/15', dot: 'bg-orange-500', label: 'High' },
  medium: { color: 'text-yellow-400', bg: 'bg-yellow-500/15', dot: 'bg-yellow-500', label: 'Medium' },
...
const KANBAN_COLUMNS: KanbanColumnConfig[] = [
  ...
  { id: 'in_progress', titleKey: 'inProgress', dotColor: 'bg-blue-400', borderColor: 'border-l-blue-400', status: 'in_progress' },
