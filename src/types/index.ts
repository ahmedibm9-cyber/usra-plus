...
export type AppPage = 'dashboard' | 'tasks' | 'calendar' | 'milestones' | 'chores' | 'grocery' | 'meal-plan' | 'chat' | 'files' | 'budget' | 'settings';
...
export type SubscriptionPlan = 'free' | 'pro' | 'family_plus' | 'max' | 'ultimate';
